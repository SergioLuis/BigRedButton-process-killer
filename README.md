Big Red Button - Process Killer
-------------------------------

A very simple CLI application that randomly kills a process whenever DreamCheeky's Big Red Button is pressed.
This requires [Big Red Button for .NET](https://github.com/mbenford/dreamcheeky-big-red-button-dotnet)
